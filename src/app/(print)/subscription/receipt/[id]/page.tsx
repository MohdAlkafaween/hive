...
interface ReceiptData {
  ...
  items: { name: string; basePrice: number; options: { name: string; price: number }[]; finalPrice: number; quantity: number }[]
  total: number
...
export default function SubscriptionReceiptPage() {
  ...
  useEffect(() => {
    const fetchReceipt = async () => {
      try {
        const res = await fetch(`/api/transactions/${params.id}/receipt`)
    ...
    <>
      ...
      <div className="receipt">
        ...
        <div className="receipt-center">
          ...
          <div className="receipt-type">SUBSCRIPTION RECEIPT</div>
        </div>
        ...
        {receipt.studentId && (
          <div className="row">
            ...
            <span className="val">{receipt.studentId}</span>
          </div>
        )}
